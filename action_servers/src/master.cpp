...
int main(int argc, char** argv) {
    ...
    angle_PID_goal.target_angle = 50;
    ...
    actionlib::SimpleActionClient<action_servers::forwardPIDAction> forwardPIDClient("forwardPID");    
    action_servers::forwardPIDGoal forward_PID_goal;
